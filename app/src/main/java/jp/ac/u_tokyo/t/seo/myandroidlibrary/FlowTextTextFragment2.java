...
public class FlowTextTextFragment2 extends Fragment{

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state){
        super.onCreateView(inflater,container,state);
        return inflater.inflate(R.layout.fragment_text_test2,container,false);
    }
    ...
    public void onViewCreated(View view, Bundle state){
        ...
        final FlowTextView text = (FlowTextView)view.findViewById(R.id.flowText);
